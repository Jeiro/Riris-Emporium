        ...
        return (
            <AdminLayout>
                <div className="min-h-screen flex flex-col items-center justify-center gap-4">
                    <div className="w-12 h-12 border-4 border-[#F5F1E8] border-t-[#8B5A2B] rounded-full animate-spin" />
                    <p className="text-[#A67B5B] text-sm font-bold uppercase tracking-widest">Loading Catalog Detail...</p>
                </div>
            </AdminLayout>
        );
    }
            ...
            <div className="max-w-5xl mx-auto p-6 lg:p-10 space-y-10">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <p className="text-[10px] font-bold text-[#A67B5B] uppercase tracking-[0.2em] mb-1">Product Studio / Edit</p>
                    ...
                    <div className="flex gap-3">
                        ...
                        >
                            {isSaving ? <Loader2 className="animate-spin" size={18} /> : <span>Update Record</span>}
                        </Button>
                    </div>
                </div>
                ...
                {success && (
                    <div className="p-4 bg-emerald-50 border border-emerald-100 rounded-2xl text-emerald-700 text-sm flex items-center gap-3 animate-fade-in">
                        <CheckCircle2 size={18} /> Catalog updated successfully.
                    </div>
                )}
                    ...
                    <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between p-4 bg-[#FAF7F2] rounded-2xl border border-[#E8DFD0]">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm font-bold text-[#5D3A1A]">Featured</span>
                                    </div>
                                    <Switch
                                ...
                                <div className="grid gap-2">
                                    <label className="text-[10px] font-bold text-[#A67B5B] uppercase tracking-widest pl-1">Product SKU</label>
                                    <div className="w-full px-5 py-3.5 bg-white border border-[#F5F1E8] rounded-2xl text-[#A67B5B] text-sm font-mono flex items-center justify-between">
                            ...
                            <div className="grid gap-6">
                                <div className="grid gap-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-5 py-3.5 bg-[#FAF7F2] border border-[#D4C4A8] rounded-2xl focus:outline-none font-bold text-[#8B5A2B] text-lg"
                                    />
                                </div>
                                <div className="grid gap-2">
                                    <label className="text-[10px] font-bold text-[#A67B5B] uppercase tracking-widest pl-1">Original Price</label>
                                    <input
                                        type="number"
                                        value={formData.compareAtPrice}
                                        onChange={(e) => setFormData({ ...formData, compareAtPrice: e.target.value })}
                                        className="w-full px-5 py-3.5 bg-[#FAF7F2] border border-[#D4C4A8] rounded-2xl focus:outline-none font-medium text-[#A67B5B] line-through text-sm"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl border border-[#E8DFD0] p-8 shadow-sm space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="grid gap-2">
                                    <label className="text-[10px] font-bold text-[#A67B5B] uppercase tracking-widest pl-1">In Stock</label>
                                    <input
                                        type="number"
                                        value={formData.stock}
                                        onChange={(e) => setFormData({ ...formData, stock: e.target.value })}
                                        className="w-full px-5 py-3.5 bg-[#FAF7F2] border border-[#D4C4A8] rounded-2xl focus:outline-none font-bold text-[#5D3A1A] text-sm text-center"
                                    />
                                </div>
                            </div>
                        </div>
